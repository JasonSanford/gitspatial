...
ALLOWED_HOSTS = ['localhost', 'gitspatial.herokuapp.com', 'gitspatial.com']
...
SECRET_KEY = '5+p6dbgtv6wc=^+!r8g+bd$3rxxj3vy3l6rw*$xu@kx-v$v+oa'
...
MIDDLEWARE_CLASSES = (
    ...
    'gitspatial.cors_middleware.XsSharing',
    'gitspatial.middleware.ImpersonateMiddleware',
